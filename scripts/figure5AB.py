...
plt.text(35.5, 18.1, '(cAD)', weight = 'bold', fontsize=28)
...
plt.text(35.5,17.9, '(Gal4 cAD)', weight = 'bold', fontsize=28)
...
plt.ylabel('Mutations', fontsize=22)
ax.tick_params(axis='both', which='major', labelsize=20)
plt.text(35.4, 18.5, '(Ino2 nAD)', weight = 'bold')
#plt.plot([12.05, 12.05], [0,22], lw=5,c='k')
#plt.plot([17.05, 17.05], [0,22], lw=5,c='k')
ax.set_ylim(-0.5, 20.5)
ax.spines['bottom'].set_position(('data',0))
...
plt.ylabel('Mutations', fontsize=22)
ax.tick_params(axis='both', which='major', labelsize=20)
plt.text(35.5,13.3, '(Ino2 cAD)', weight = 'bold')
#plt.plot([12.05, 12.05], [0,22], lw=5,c='k')
#plt.plot([17.05, 17.05], [0,22], lw=5,c='k')
ax.set_ylim(-0.5, 20.5)
ax.spines['bottom'].set_position(('data',0))
