...
if '--calculate-likelihood-ratio' in sys.argv:
    ...
    im = ax.pcolor(models_dipept[best].coef_.reshape(20,20), cmap='seismic', vmin=vmin, vmax=vmax, norm=norm) #jet_r') #Spectral', )
    ...
    plt.xlabel('dipeptide logistic regression coefficients', fontsize=18)
