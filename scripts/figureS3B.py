...
for n,i in enumerate(filesN+filesP):
    print("{} adpred score = {:.4f}".format(i[:-4], y[n]))
...
ax1.scatter (np.log(NN_scores), np.log(experimental), s=200)
...
f.savefig('ARG3_fig.pdf', format='pdf')
...
f.savefig('HIS4_fig.pdf', format='pdf')